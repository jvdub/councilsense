          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-3xl text-lg leading-8 text-slate-300">
                Stay informed about your local government meetings with concise
                summaries, notable topics, and evidence-backed details that help
                residents follow what happened and what comes next.
              </p>
            </div>
          ...
          <div className="grid gap-4">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                Follow agendas, decisions, and actions without digging through
                long minutes.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                Confidence indicators and evidence references help you verify
                important claims.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                See what was approved, what staff must do next, and which topics
                deserve attention.
              </p>
            </div>
          </div>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        <article className="rounded-3xl border border-slate-200/80 bg-white/85 p-6 shadow-lg shadow-slate-200/60 backdrop-blur">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Browse recent meetings, then open a detail view for summaries,
            decisions, actions, and evidence.
          </p>
        </article>
        <article className="rounded-3xl border border-slate-200/80 bg-white/85 p-6 shadow-lg shadow-slate-200/60 backdrop-blur">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Low-confidence results are highlighted so you can double-check
            evidence before sharing or acting.
          </p>
        </article>
        <article className="rounded-3xl border border-slate-200/80 bg-white/85 p-6 shadow-lg shadow-slate-200/60 backdrop-blur">
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Configure your home city, notifications, export requests, and
            deletion preferences in one place.
          </p>
        </article>
      </section>
    </main>
