...
- [x] [TASK-ST-008-05](TASK-ST-008-05.md) — ST-008 End-to-End Settings and Push Flow Tests
...
- 2026-02-27: `npm --prefix frontend run test -- src/app/settings/SettingsPreferencesForm.test.tsx src/app/settings/page.test.tsx` (pass, 15/15 tests).
