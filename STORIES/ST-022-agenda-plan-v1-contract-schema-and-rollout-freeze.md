...
- [ ] Author v1 API contract spec for planned/outcomes/mismatch/evidence v2 shapes.
- [ ] Author additive schema spec and migration sequence for canonical document entities.
- [ ] Define idempotency key naming rules and stage ownership table.
- [ ] Define rollout flag matrix and rollback sequence documentation.
- [ ] Create and review contract fixtures for backend/frontend tests.
